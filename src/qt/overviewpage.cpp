    ...
    filter(0)
{
    ...
    ui->labelWalletStatus->setText("(" + tr("Out of sync with the communitygeneration network") + ")");
    ui->labelTransactionsStatus->setText("(" + tr("Out of sync with the communitygeneration network") + ")");
...
void OverviewPage::setModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("communitygeneration")
    updateDisplayUnit();
}
